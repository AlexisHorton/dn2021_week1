...
namespace LoopDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            q += 5;  // Same as q = q + 5 == it adds to 5 + q
            Console.WriteLine(q);
            ...
            for (int i = 0; i <= 10; i++)
                // Loop variables only exist inside the loop
            {
                Console.WriteLine(i);
            }
            ...
            for (int i = 10; i > 0; i--)
            {
                //int r = 5; // Question: Does this go away? What is its scope? Plat with it and find out
                Console.WriteLine(i);
                //Console.WriteLine(r);
            }
