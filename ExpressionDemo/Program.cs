...
namespace ExpressionDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            x = 100;
            y = 3;
            z = x / y;  // 100/3 = 33.333333 which is NOT an integer. But, I'm storing that number in an integer. 
            ...
            // Instead of asking it as a question, "Is x greater than y" which typically er respond with yes or no,
            ...
            //Console.WriteLine( 10 / 3 == 3); //WTF -- normally we don't do this to ourselves -- be careful and try not to do

            string first = "hello";
            string second = "hello";
            Console.WriteLine(first == second); // We get "true" back in C#, but some langs like Java will give false.
        }
    }
}
